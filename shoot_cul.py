...
ROOT=os.path.join(os.getcwd(),'site'); PORT=8874
def serve():
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await pg.evaluate("()=>{document.querySelector('.ohc2').scrollIntoView();}"); await pg.wait_for_timeout(900)
        await pg.screenshot(path='shots/v4-culture.png')
        await b.close()
asyncio.run(main())
